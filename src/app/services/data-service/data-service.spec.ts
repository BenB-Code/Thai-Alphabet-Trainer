...
describe('DataService', () => {
  ...
  describe('Thai Consonants', () => {
    it('getAllConsonants should return all consonants', () => {
      ...
      expect(result.length).toEqual(CONSONANTS_DATA.length);
    });

    it('getAllConsonants should return a copy, not the original', () => {
      const result = service.getAllConsonants();

      expect(result).not.toBe(CONSONANTS_DATA);
    });
    ...
    it('getAllConsonantsSorted should group by class', () => {
      ...
      expect(totalCount).toEqual(CONSONANTS_DATA.length);
    ...
    it('getConsonantById should return corresponding consonant entry', () => {
      ...
      const expected = CONSONANTS_DATA.find(consonant => consonant.id === 3);
    ...
    it('getConsonantByClass should return corresponding consonants list', () => {
      ...
      const expected = CONSONANTS_DATA.filter(consonant => consonant.class === MID);
  ...
  describe('Thai Vowels', () => {
    it('getAllVowels should return all vowels', () => {
      ...
      expect(result.length).toEqual(VOWELS_DATA.length);
    });

    it('getAllVowels should return a copy, not the original', () => {
      const result = service.getAllVowels();

      expect(result).not.toBe(VOWELS_DATA);
    });
    ...
    it('getAllVowelsSorted should group by type', () => {
      ...
      expect(totalCount).toEqual(VOWELS_DATA.length);
    ...
    it('getVowelById should return corresponding vowel entry', () => {
      ...
      const expected = VOWELS_DATA.find(vowel => vowel.id === 3);
    ...
    it('getVowelByLength should return corresponding vowels list', () => {
      const result = service.getVowelByLength(LONG);
      const expected = VOWELS_DATA.filter(vowel => vowel.length === LONG);
